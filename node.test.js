...
var $;
(function ($) {
    class $my_agreement extends $.$mol_view {
        sub() {
            return [
                this.Title(),
                this.License(),
        ...
        Agree() {
            ...
            obj.title = () => this.$.$mol_locale.text('$my_agreement_Agree_title');
            return obj;
        }
        Submit() {
            const obj = new this.$.$mol_button_major();
            obj.enabled = () => this.agree();
            obj.title = () => this.$.$mol_locale.text('$my_agreement_Submit_title');
            return obj;
        }
        Form() {
            const obj = new this.$.$mol_view();
    ...
    __decorate([
        $.$mol_mem
    ], $my_agreement.prototype, "Title", null);
    __decorate([
        $.$mol_mem
    ], $my_agreement.prototype, "License", null);
    __decorate([
        $.$mol_mem
    ], $my_agreement.prototype, "agree", null);
    __decorate([
        $.$mol_mem
    ], $my_agreement.prototype, "Agree", null);
    __decorate([
        $.$mol_mem
    ], $my_agreement.prototype, "Submit", null);
    __decorate([
        $.$mol_mem
    ], $my_agreement.prototype, "Form", null);
    $.$my_agreement = $my_agreement;
})($ || ($ = {}));
//agreement.view.tree.js.map
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        $_1.$mol_test({
            'Enable submit ony when agree'($) {
                const app = new $_1.$my_agreement;
                app.$ = $;
                $_1.$mol_assert_not(app.Submit().enabled());
                app.Agree().click();
                $_1.$mol_assert_ok(app.Submit().enabled());
                app.Agree().click();
                $_1.$mol_assert_not(app.Submit().enabled());
            }
        });
